...
import com.example.runtrackerapp.other.Constants.FASTEST_LOCATION_INTERVAL
import com.example.runtrackerapp.other.Constants.LOCATION_UPDATE_INTERVAL
import com.example.runtrackerapp.other.Constants.NOTIFICATION_CHANNEL_ID
import com.example.runtrackerapp.other.Constants.NOTIFICATION_CHANNEL_NAME
import com.example.runtrackerapp.other.Constants.NOTIFICATION_ID
import com.example.runtrackerapp.other.Constants.TIMER_UPDATE_INTERVAL
        ...
        CoroutineScope(Dispatchers.Main).launch {
            while (isTracking.value!!){
                ...
                if(timeRunInMillis.value!! >= lastSecondTimestamp + 1000L){
                   timeInRunSeconds.postValue(timeInRunSeconds.value!! + 1)
